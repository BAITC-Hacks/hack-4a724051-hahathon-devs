...
const WARNING_LABELS: Record<string, string> = {
  ...
  vision_analysis_unavailable: "Фото или скан не прочитаны: проверьте подключение модели и разрешите анализ выбранных файлов.",
  model_document_context_truncated: "Модели передана часть текста. Разделите большой документ на несколько файлов для полного разбора.",
  document_queries_truncated: "Обработаны первые 20 артикулов. Оставшиеся позиции отправьте отдельным сообщением.",
