...
export type AssistantOutput = { reference_product_id?: number | null; message: string; products: Product[]; unknowns: string[]; mode: "catalog_only" | "unavailable" | "grounded" | "action"; language: "ru" | "kk" | "en"; proposal: Proposal | null; sources: string[]; alternative_reasons: Record<string, string>; warnings: string[] };
